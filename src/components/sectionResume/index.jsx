...
const about = {
  ...
  info: [
    {
      fieldName: "Name",
      fieldValue: "Evgenii Lepekho",
    },
    {
      fieldName: "Phone",
      fieldValue: "8(909) 778 35 67",
    },
    {
    ...
    {
      fieldName: "Skype",
      fieldValue: "Evgenii.01",
    },
    {
      fieldName: "Email",
      fieldValue: "lepehun@mail.ru",
    },
    {
      fieldName: "Email",
      fieldValue: "lepehoe@gmail.com",
    },
    {
      fieldName: "Languages",
...
const education = {
  ...
  items: [
    {
      institution: "Online Course With Mentors",
      degree: "Front-End Developer",
      duration: "summer-autumn 2023",
    },
    {
      institution: "Online Course Platform RS School",
      degree: "Front-End Developer",
          ...
          <div className="min-h-[70vh] w-full">
            ...
            <TabsContent value="experience" className="w-full">
              <div className="flex flex-col gap-[30px] text-center xl:text-left">
                <LinkVisuallyHidden linkId="resume" />
